...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<PgResponseEntity>[] is M) {
      return data.map<PgResponseEntity>((Map<String, dynamic> e) =>
          PgResponseEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (OrderItemByIDDataCartProduct).toString(): OrderItemByIDDataCartProduct
        .fromJson,
    (PgResponseEntity).toString(): PgResponseEntity.fromJson,
